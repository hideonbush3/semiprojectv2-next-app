  ...
  return (
    <main>
      ...
      <div id="view">
        ...
        <div>
          <label className="drgup">본 문</label>
          <span id="contents">{board.contents}</span>
        </div>
        ...
        <div>
          ...
          <button type="button" onClick={newOne}>
            새글쓰기
          </button>
          <button type="button" onClick={go2list}>
            목록으로
          </button>
          <button type="button" onClick={updateOne}>
            수정하기
          </button>
